  ...
  head: () => ({
    meta: [
      { title: "Brand Partners | Mitsubishi, Pall, Parker, NSK, THK | Alfa Tooling" },
      {
        name: "description",
        content:
          "Authorised supplier of global brands including Mitsubishi, Pall, Parker, NSK, THK, Omron and Schneider Electric.",
      },
    ...
    <SiteLayout>
      <section className="border-b border-border bg-secondary">
        <div className="container mx-auto px-4 py-10">
          ...
          <p className="mt-2 text-muted-foreground max-w-2xl">
            We supply genuine products from these globally recognised industrial brands.
          </p>
        </div>
      </section>
      <section className="container mx-auto px-4 py-12 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
        {brands.map((b) => (
          <div
            key={b.id}
            className="border border-border rounded-lg p-6 bg-card hover:border-orange transition-colors"
          >
