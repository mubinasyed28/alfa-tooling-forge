    ...
    meta: [
      { title: `${loaderData?.category.name ?? "Category"} — CNC Spare Parts | Alfa Tooling` },
      {
        ...
        content:
          ...
          "Industrial spare parts and tooling from Alfa Tooling Systems.",
      },
    ...
    <SiteLayout>
      <section className="border-b border-border bg-secondary">
        <div className="container mx-auto px-4 py-8">
          ...
          {data.category.description && (
            <p className="mt-2 text-muted-foreground max-w-2xl">{data.category.description}</p>
          )}
        </div>
      </section>
      ...
      {data.children.length > 0 && (
        <section className="container mx-auto px-4 pt-10">
          <h2 className="text-sm font-semibold uppercase tracking-wider text-orange mb-4">
            Sub-categories
          </h2>
          <div className="flex flex-wrap gap-2">
            {data.children.map((c) => (
              <Link
                ...
                className="rounded border border-border bg-card px-4 py-2 text-sm font-medium hover:border-orange hover:text-orange transition-colors"
              >
                {c.name}
              </Link>
            ))}
      ...
      <section className="container mx-auto px-4 py-10">
        ...
        {data.products.length === 0 ? (
          <p className="text-muted-foreground">
            ...
            <Link to="/contact" className="text-orange underline">
              Contact us
            </Link>{" "}
            for availability.
          </p>
