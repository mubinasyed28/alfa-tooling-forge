    ...
    <div>
      <div className="flex items-center justify-between gap-4 flex-wrap mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={openCreate}
            className="flex items-center gap-2 rounded bg-orange px-4 py-2 text-sm font-semibold text-orange-foreground hover:opacity-90"
          >
          ...
          <tbody>
            ...
            {(products as any[]).map((p: any) => (
              <tr key={p.id} className="border-b border-border last:border-0 hover:bg-secondary/40">
                ...
                <td className="p-3">
                  <span
                    className={`text-xs rounded px-2 py-0.5 ${p.is_published ? "bg-green-100 text-green-800" : "bg-secondary text-muted-foreground"}`}
                  >
                    {p.is_published ? "Published" : "Draft"}
                  </span>
                  {p.is_placeholder && (
                    <span className="ml-2 text-xs rounded px-2 py-0.5 bg-orange/10 text-orange">
                      Placeholder
                    </span>
                  )}
                </td>
                ...
                <td className="p-3">
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() => openEdit(p)}
                      className="flex items-center gap-1 rounded border border-border px-2 py-1 text-xs hover:border-orange hover:text-orange"
                    >
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Pall HC9601FUS8H"
                    className={inputCls}
                  />
                </div>
                <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      onKeyDown={(e) => {
                        if (e.key === "Enter") {
                          ...
                          if (val) {
                            setForm((f) => ({ ...f, image_urls: [...f.image_urls, val] }));
                    ...
                    <button
                      ...
                      disabled={uploading}
                      className="flex items-center gap-1.5 rounded border border-border px-3 py-2 text-xs hover:border-orange hover:text-orange"
                    >
                  ...
                  <p className="text-xs text-muted-foreground">
                    Press Enter to add URL, or upload a file. Accepts JPG, PNG, WebP.
                  </p>
                </div>
              </div>
                    ...
                    <div key={i} className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        onClick={() =>
                          setForm((f) => ({
                            ...f,
                            video_urls: f.video_urls.filter((_, j) => j !== i),
                          }))
                        }
                        className="text-red-400 hover:text-red-600"
                      >
                    ...
                    <input
                      ...
                      onKeyDown={(e) => {
                        if (e.key === "Enter") {
                          ...
                          const val = (e.target as HTMLInputElement).value.trim();
                          if (val) {
                            setForm((f) => ({ ...f, video_urls: [...f.video_urls, val] }));
                            (e.target as HTMLInputElement).value = "";
                          }
                        }
                      }}
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder={"CNC machining centers\nHydraulic systems"}
                    className={inputCls}
                  />
                </div>
                <div>
              ...
              <div>
                <label className={labelCls}>
                  Technical Specifications (Key: Value, one per line)
                </label>
                <textarea
                  rows={4}
                  value={form.specs}
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  ...
                  className="rounded bg-orange px-5 py-2.5 text-sm font-semibold text-orange-foreground hover:opacity-90 disabled:opacity-50"
                >
