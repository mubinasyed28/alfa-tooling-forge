  ...
  head: () => ({
    meta: [
      { title: "Contact Alfa Tooling Systems | CNC Spare Parts Supplier Delhi" },
      {
        name: "description",
        content:
          "Get in touch for CNC tooling, filtration systems and industrial spare parts. Call +91-9311788034 or email sales@sphinxconsultants.in.",
      },
      ...
      <section className="container mx-auto px-4 py-12 grid lg:grid-cols-[1fr_1.2fr] gap-10">
        <div className="space-y-6">
          <div className="border border-border rounded-lg p-6 bg-card space-y-4">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground">Pandav Nagar, New Delhi, India</div>
              </div>
            </div>
            <div className="flex gap-3">
            ...
            <div className="flex gap-3">
              <Phone className="h-5 w-5 text-orange shrink-0 mt-0.5" />
              <div>
                <div className="font-semibold text-navy">Mobile / WhatsApp</div>
                <div className="text-sm text-muted-foreground">+91-9311788034</div>
              </div>
            </div>
            <div className="flex gap-3">
              <Mail className="h-5 w-5 text-orange shrink-0 mt-0.5" />
              <div>
                <div className="font-semibold text-navy">Email</div>
                <div className="text-sm text-muted-foreground">
                  <a href="mailto:sales@sphinxconsultants.in" className="hover:underline">
                    sales@sphinxconsultants.in
                  </a>
                  <br />
                  hidayat@alfatooling.com
                </div>
              </div>
            </div>
          </div>
          <a
            href="https://wa.me/919311788034"
            target="_blank"
            rel="noreferrer"
            className="flex items-center justify-center gap-2 rounded px-5 py-3 text-sm font-semibold text-white"
          ...
          <div className="aspect-video rounded-lg overflow-hidden border border-border">
            <iframe
              ...
              src="https://www.google.com/maps?q=Pandav+Nagar+New+Delhi&output=embed"
            />
          </div>
        </div>
        <form
        ...
        >
          ...
          {(["name", "email", "phone", "company"] as const).map((f) => (
            <div key={f}>
              ...
              <input
                ...
                className="mt-1 w-full rounded border border-input bg-background px-3 py-2 text-sm focus:border-orange focus:outline-none"
              />
            </div>
          ))}
          <div>
          ...
          <button
            ...
            className="w-full rounded bg-orange px-5 py-3 text-sm font-semibold text-orange-foreground hover:opacity-90 disabled:opacity-50"
          >
