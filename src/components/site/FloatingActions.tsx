  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex flex-col gap-2">
      <a
        ...
        aria-label="Call"
        className="grid h-12 w-12 place-items-center rounded-full bg-navy text-navy-foreground shadow-lg hover:scale-105 transition-transform"
      >
      ...
      <a
        ...
        rel="noreferrer"
        aria-label="WhatsApp"
        className="grid h-12 w-12 place-items-center rounded-full shadow-lg hover:scale-105 transition-transform"
