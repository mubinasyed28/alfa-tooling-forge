      ...
      <div className="container mx-auto px-4 py-14 grid gap-10 md:grid-cols-4">
        <div>
          ...
          <p className="text-sm text-navy-foreground/70 leading-relaxed">
            Trusted supplier of CNC tooling, filtration systems and industrial spare parts since
            2005.
          </p>
        </div>
        <div>
          ...
          <ul className="space-y-2 text-sm text-navy-foreground/70">
            <li>
              <Link to="/catalog" className="hover:text-orange transition-colors">
                All Categories
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link
                to="/catalog/$category"
                params={{ category: "filtration-systems" }}
                className="hover:text-orange"
              >
                Filtration Systems
              </Link>
            ...
            <li>
              <Link
                to="/catalog/$category"
                params={{ category: "atc-spare-parts" }}
                className="hover:text-orange"
              >
                ATC Spare Parts
              </Link>
            ...
            <li>
              <Link to="/brands" className="hover:text-orange">
                Brands
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-navy-foreground/70">
            ...
            <li>
              <Link to="/resources" className="hover:text-orange">
                Resources
              </Link>
            </li>
            <li>
              <Link to="/quote" className="hover:text-orange">
                Request a Quote
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-navy-foreground/70">
            <li className="flex gap-2">
              ...
              Pandav Nagar, New Delhi, India
            </li>
            <li className="flex gap-2">
              <Phone className="h-4 w-4 mt-0.5 shrink-0 text-orange" />
              <span>
                011-43052451
                <br />
                +91-9811089003
            ...
            <li className="flex gap-2">
              <Mail className="h-4 w-4 mt-0.5 shrink-0 text-orange" />
